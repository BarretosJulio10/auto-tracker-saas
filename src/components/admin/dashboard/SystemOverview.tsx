  ...
  return (
    <div className="lg:col-span-2 bg-white rounded-lg p-6 shadow-sm border">
      ...
      <div className="space-y-6">
        <div>
          <h4 className="text-sm font-medium text-muted-foreground mb-2">Distribuição de Protocolos de Rastreamento</h4>
        ...
        <div>
          <h4 className="text-sm font-medium text-muted-foreground mb-2">Status dos Dispositivos</h4>
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-lg p-4">
              <h5 className="text-amber-700 font-medium">Parado</h5>
        ...
        <div>
          <h4 className="text-sm font-medium text-muted-foreground mb-2">Saúde do Sistema</h4>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-green-500"></div>
            <span className="text-green-700 font-medium">Todos os sistemas operacionais</span>
          </div>
        </div>
      </div>
    </div>
